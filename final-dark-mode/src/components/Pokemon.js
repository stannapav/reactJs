...
function Pokemon(props) {
  ...
  return (
    <div
      className={props.darkMode ? "pokemon-card-dark" : "pokemon-card"}
    ...
    >
      ...
      {isShown && (
        <>
          <div className={props.darkMode ? "info-group-dark" : "info-group"}>
            <p>
          ...
          <a
            ...
            href={props.linkToPokedex}
          >
            More info about {props.name}
          </a>
        </>
      )}
